...
<head>
	...
	@import url('https://fonts.googleapis.com/css2?family=Arvo&display=swap');
		...
		.gambar{
			width: 600px;
			height: 400px;
			background-image: url(style/img/home1.png);
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="textt nav-item">
                    <a class="nav-link" onclick="return invalid(this)" href="history.php?$id=<?php echo $sessionid ?>user=<?php echo $sessionuser ?>" >History</a>
                </li>
                <li class="textt nav-item">
                    <a class="nav-link" href="#info">Info</a>
                </li>
                <li class="textt nav-item">
                    <a href="#"><p class="nav-link"><?php echo $sessionuser ?></p></a>
                    <!-- profile.php?id=<?php echo $d['id_user']; ?> -->
                </li>
                <li class="textt nav-item">
	...
	<div class="layer pertama">
		<div class="sec-1">
			...
			<div>
				<a href="pinjam.php" class="button"><button>Mulai Pinjam Dana</button></a>
				<a href="simpan.php" class="button"><button>Mulai Simpan Dana</button></a>
				<a href="gadai.php" class="button"><button>Mulai Gadai</button></a>
			</div>
		</div>
		<div class="sec-2">
			<h2 class="gambar"></h2>
