...
if (isset($_POST['submit'])) {
	...
	$brg	  		= $_POST['barang'];
	$lama      		= $_POST['lama_gadai'];
	$waktu          = $_POST['waktu'];
	// query SQL untuk insert data


	$querynya = "INSERT INTO gadai VALUES('','$username','$brg','$lama','$waktu')";
...
<body>
	...
	<div class="container">
		...
		<div class="contain textt">
			<div class="Sub">Petunjuk Penggadaian Barang</div>
			<div class="textt">Barang dapat digadaikan dengan ketentuan tidak melebihi waktu 10 tahun dari saat ini</div>
		</div>
		<!-- Card -->

		<div class="layer 2">
			<div class="grid">
				<div class="bagian kiri background">
					<div class="judul-sec">
					</div>
				...
				<div class="bagian kanan">
					<form method="post" action="gadai.php" onsubmit="return alerta_save_load(this)">
						<table border="0">
							<tr><span class="judul-form">Gadai Barang</span></tr>
							<tr>

								<td><input readonly class="form-text" type="text" name="username" maxlength="25" value=<?php echo $sessionuser ?>></td>
							</tr>
							<tr>
								<td><input class="form-text" type="text" name="barang" maxlength="12" required placeholder="Barang yang ingin digadai"></td>
							</tr>
							<tr>
								<td><input class="form-text" type="number" name="lama_gadai" maxlength="12" required placeholder="Lama Gadai (tahun)"></td>
							</tr>
							<tr>
								<td><input class="form-text" type="text" name="waktu" readonly value="<?php echo date('l,  d-m-y - h:i:s a') ?>"></td>
							</tr>
							<tr>

							<tr>
								<td colspan="2"><button class="btn btn-primary" type="submit" name="submit" value="simpan">Gadaikan Barang</button></td>
								<td></td>
							</tr>
						</table>
					</form>
